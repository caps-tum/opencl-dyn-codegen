...
*/
__kernel void Stencil1(__global float* in, __global float* out, 
...
*/
__kernel void Stencil4(__global float* in, __global float* out, 
					int width, int height) //, __local float* Buffer)
{
...
*	output point. e.g.: "normal" Stencil would be: {0,-1, -1,0, 1,0, 0,1}
*/
...
*/	
	...
	out[pos] = sum/sumOfWeights;//numberPoints;
}

/*
*	Not doing any aktual work; just for testing.
*/

__kernel void dynamicStencil1_Copy_kernel(__global float* in, __global float* out, 
